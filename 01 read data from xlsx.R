...
CFR_1819 <- read(COR_pru_1819, 5, 4, -4) %>% gather(var, value, 6:15) %>% mutate(Year = "2018-19", source = COR_pru_1819, tab = tabs_pru_1819[5,], published = ymd("2019-09-26"))
borrowing_lending_1819 <- read(COR_pru_1819, 6, 4, -4) %>% gather(var, value, 6:24)  %>% mutate(Year = "2018-19", source = COR_pru_1819, tab = tabs_pru_1819[6,], published = ymd("2019-09-26"))
fin_1819 <- read(COR_fin_1819, 5, 4, -4) %>% gather(var, value, 6:25) %>% mutate(Year = "2018-19", source = COR_fin_1819, tab = tabs_fin_1819[5,], published = ymd("2019-09-26"))

pru_1718 <- read(COR_pru_1718,4, 4, -4) %>% gather(var, value, 6:34) %>% mutate(Year = "2017-18", source = COR_pru_1718, tab = tabs_pru_1718[4,], published = ymd("2018-10-11"))
fin_1718 <- read(COR_fin_1718, 4, 4, -5) %>% gather(var, value, 6:28) %>% mutate(Year = "2017-18", source = COR_fin_1718, tab = tabs_fin_1718[4,], published = ymd("2018-10-11"))

fin_1617 <- read(COR_1617, 5, 6, -6) %>% gather(var, value, 5:49) %>% mutate(Year = "2016-17", source = COR_1617, tab = tabs_1617[5,], published = ymd("2017-09-28"))
fin_1516 <- read(COR_1516, 4, 1, -1) %>% gather(var, value, 5:47) %>% mutate(Year = "2015-16", source = COR_1516, tab = tabs_1516[4,], published = ymd("2016-09-15"))
fin_1415 <- read(COR_1415, 4, 1, -1) %>% gather(var, value, 4:42) %>% mutate(Year = "2014-15", source = COR_1415, tab = tabs_1415[4,], published = ymd("2015-10-07")) %>% rename(la_name = na_2)
fin_1314 <- read(COR_1314, 4, 1, -1) %>% gather(var, value, 4:53) %>% mutate(Year = "2013-14", source = COR_1314, tab = tabs_1314[4,], published = ymd("2015-03-26")) %>% rename(la_name = na_2)
fin_1213 <- read(COR_1213, 4, 1, -5) %>% gather(var, value, 4:53) %>% mutate(Year = "2012-13", source = COR_1213, tab = tabs_1213[4,], published = ymd("2013-10-17")) %>% rename(la_name = na_2)
fin_1112 <- read(COR_1112, 4, 1, -1) %>% gather(var, value, 5:57) %>% mutate(Year = "2011-12", source = COR_1112, tab = tabs_1112[4,], published = ymd("2013-02-14"))
fin_1011 <- read(COR_1011, 4, 1, -1) %>% gather(var, value, 5:54) %>% mutate(Year = "2010-11", source = COR_1011, tab = tabs_1011[4,], published = ymd("2011-10-26"))
fin_0910 <- read(COR_0910, 5, 2, -2) %>% gather(var, value, 5:54) %>% mutate(Year = "2009-10", source = COR_0910, tab = tabs_0910[5,], published = ymd("2010-10-28"))
fin_0809 <- read(COR_0809, 4, 1, -2) %>% gather(var, value, 5:54) %>% mutate(Year = "2008-09", source = COR_0809, tab = tabs_0809[4,], published = ymd("2010-04-08")) %>% rename(la_name = na_2)
fin_0708 <- read(COR_0708, 4, 1, -2) %>% gather(var, value, 5:55) %>% mutate(Year = "2007-08", source = COR_0708, tab = tabs_0708[4,], published = ymd("2008-12-31")) %>% rename(la_name = na_2)
fin_0607 <- read(COR_0607, 4, 2, -2) %>% gather(var, value, 5:55) %>% mutate(Year = "2006-07", source = COR_0607, tab = tabs_0607[4,], published = ymd("2013-08-01"))
fin_0506 <- read(COR_0506, 4, 2, -2) %>% gather(var, value, 5:53) %>% mutate(Year = "2005-06", source = COR_0506, tab = tabs_0506[4,], published = ymd("2013-08-01"))
fin_0405 <- read(COR_0405, 4, 2, -2) %>% gather(var, value, 5:55) %>% mutate(Year = "2004-05", source = COR_0405, tab = tabs_0405[4,], published = ymd("2013-08-01"))
fin_0304 <- read(COR_0304, 4, 1, -1) %>% gather(var, value, 5:57) %>% mutate(Year = "2003-04", source = COR_0304, tab = tabs_0304[4,], published = ymd("2013-08-01"))
fin_0203 <- read(COR_0203, 4, 1, -2) %>% gather(var, value, 5:57) %>% mutate(Year = "2002-03", source = COR_0203, tab = tabs_0203[4,], published = ymd("2013-08-01"))
fin_0102 <- read(COR_0102, 4, 1, -1) %>% gather(var, value, 5:56) %>% mutate(Year = "2001-02", source = COR_0102, tab = tabs_0102[4,], published = ymd("2013-08-01"))
fin_0001 <- read(COR_0001, 4, 1, -2) %>% gather(var, value, 5:57) %>% mutate(Year = "2000-01", source = COR_0001, tab = tabs_0001[4,], published = ymd("2013-08-01"))
